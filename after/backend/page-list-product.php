                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                            <?php
                                echo "<div>" . $row["Product"] . "</div></div></td>";
                                echo "<td>" . $row["Code"] . "</td>";
                            ...
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"
                                        href="page-edit-product.php?product=<?php echo $row["Product"] ?>&code=<?php echo $row["Code"] ?>&category=<?php echo $row["Category"] ?>&price=<?php echo $row["Price"] ?>&brandName=<?php echo $row["BrandName"] ?>&cost=<?php echo $row["Cost"] ?>&quantity=<?php echo $row["Quantity"] ?>&"><i class="ri-pencil-line mr-0"></i></a>
                                    <a class="badge bg-warning mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"
                                        href="delete.php?id=<?php echo $row["Code"] ?>" onclick="return confirm('Do you want to delete this data?');"><i class="ri-delete-bin-line mr-0"></i></a>
                                </div>
                            </td>
                        </tr>
                        <?php } ?>
