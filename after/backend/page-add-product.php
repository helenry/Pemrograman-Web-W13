                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" data-toggle="validator">
                            <div class="row">
                                ...
                                <div class="col-md-6">                      
                                    <div class="form-group">
                                        ...
                                        <input name="brandName" type="text" class="form-control" placeholder="Enter Brand Name" data-errors="Please Enter Brand Name." required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>    
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Code *</label>
                                        <input name="code" type="text" class="form-control" placeholder="Enter Code" data-errors="Please Enter Code." required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div> 
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Cost *</label>
                                        <input name="cost" type="number" class="form-control" placeholder="Enter Cost" data-errors="Please Enter Cost." required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Price *</label>
                                        <input name="price" type="number" class="form-control" placeholder="Enter Price" data-errors="Please Enter Price." required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">                                    
                            ...
                            <button name="submit" type="submit" class="btn btn-primary mr-2">Add Product</button>
                            <button type="reset" class="btn btn-danger">Reset</button>
                        </form>

                        <?php
                            if (isset($_POST['submit'])) {
                                mysqli_query($connect, "insert into product set
                                    Product = '$_POST[name]',
                                    Code = '$_POST[code]',
