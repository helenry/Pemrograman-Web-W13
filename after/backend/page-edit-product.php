                            ...
                            <div class="row">
                                <div class="col-md-6">                      
                                    <div class="form-group">
                                        <label>Name *</label>
                                        <input name="name" type="text" class="form-control" placeholder="Enter Name" data-errors="Please Enter Name." value="<?php echo $product ?>" required>
                                ...
                                <div class="col-md-6">                      
                                    <div class="form-group">
                                        ...
                                        <input name="brandName" type="text" class="form-control" placeholder="Enter Brand Name" data-errors="Please Enter Brand Name." value="<?php echo $brandName ?>" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>    
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Code *</label>
                                        <input name="code" type="text" class="form-control" placeholder="Enter Code" data-errors="Please Enter Code." value="<?php echo $code ?>" disabled>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div> 
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="category" class="selectpicker form-control" data-style="py-0">
                                            <option <?php if ($category == "Beauty") echo "selected"; ?> value="Beauty">Beauty</option>
                                            <option <?php if ($category == "Grocery") echo "selected"; ?> value="Grocery">Grocery</option>
                                            <option <?php if ($category == "Food") echo "selected"; ?> value="Food">Food</option>
                                            <option <?php if ($category == "Furniture") echo "selected"; ?> value="Furniture">Furniture</option>
                                            <option <?php if ($category == "Shoes") echo "selected"; ?> value="Shoes">Shoes</option>
                                            <option <?php if ($category == "Frames") echo "selected"; ?> value="Frames">Frames</option>
                                            <option <?php if ($category == "Jewellery") echo "selected"; ?> value="Jewellery">Jewellery</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Cost *</label>
                                        <input name="cost" type="number" class="form-control" placeholder="Enter Cost" data-errors="Please Enter Cost." value="<?php echo $cost ?>" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Price *</label>
                                        <input name="price" type="number" class="form-control" placeholder="Enter Price" data-errors="Please Enter Price." value="<?php echo $price ?>" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">                                    
                                    <div class="form-group">
                                        ...
                                        <input name="quantity" type="number" class="form-control" placeholder="Enter Quantity" value="<?php echo $quantity ?>" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                            </div>                            
                            <button name="submit" type="submit" class="btn btn-primary mr-2">Edit Product</button>
                        ...
                        <?php
                            if (isset($_POST['submit'])) {
                                if ($_POST['name'] != $product) {
                                    $query = sprintf("UPDATE product SET Product = '%s' WHERE Code = '%s'", $_POST['name'], $code);
                                    mysqli_query($connect, $query);
                                }
                                if ($_POST['category'] != $category) {
                                    $query = sprintf("UPDATE product SET Category = '%s' WHERE Code = '%s'", $_POST['category'], $code);
                                    mysqli_query($connect, $query);
                                }
                                if ($_POST['price'] != $price) {
                                    $query = sprintf("UPDATE product SET Price = '%s' WHERE Code = '%s'", $_POST['price'], $code);
                                    mysqli_query($connect, $query);
                                }
                                if ($_POST['brandName'] != $brandName) {
                                    $query = sprintf("UPDATE product SET BrandName = '%s' WHERE Code = '%s'", $_POST['brandName'], $code);
                                    mysqli_query($connect, $query);
                                }
                                if ($_POST['cost'] != $cost) {
                                    $query = sprintf("UPDATE product SET Cost = '%s' WHERE Code = '%s'", $_POST['cost'], $code);
                                    mysqli_query($connect, $query);
                                }
                                if ($_POST['quantity'] != $quantity) {
                                    $query = sprintf("UPDATE product SET Quantity = '%s' WHERE Code = '%s'", $_POST['quantity'], $code);
                                    mysqli_query($connect, $query);
                                }
                        ?>
                                <script>
